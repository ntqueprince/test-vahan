...
<head>
  ...
  <style>
    ...
    .upload-section {
      ...
      margin-top: 100px; /* Adjusted margin to move it below the fixed buttons */
    }
    ...
    .vi-claim-btn,
    .endorsement-btn,
    .manual-vi-btn { /* Added manual-vi-btn to this group for consistent styling */
    ...
    .endorsement-page, .vi-claim-page, .manual-vi-page, .csat-modal { /* Added csat-modal here */
      display: none;
      position: fixed;
      top: 0;
      left: 0;
    ...
    .endorsement-container, .vi-claim-container, .manual-vi-container, .csat-modal-content { /* Added csat-modal-content here */
      width: 100%;
    ...
    .endorsement-container.active, .vi-claim-container.active, .manual-vi-container.active, .csat-modal-content.active { /* Added csat-modal-content here */
      transform: scale(1);
      opacity: 1;
    }
    .endorsement-container h1, .vi-claim-container h1, .manual-vi-container h1, .csat-modal-content h4 { /* Added csat-modal-content here */
      text-align: center;
      color: #1a237e;
      font-size: 1.8em;
      font-weight: 700;
    ...
    @media (max-width: 600px) {
      ...
      .csat-btn, .vi-claim-btn, .endorsement-btn, .manual-vi-btn {
    ...
    function populateTable(data) {
        ...
        data.forEach(item => {
            ...
            row.innerHTML = `
                ...
                <td class="p-2">${item.zd_claims_year}</td> <!-- ZD Claims/Year (New Position) -->
                <td class="p-2">${item.non_zd_claims_year}</td> <!-- Non-ZD Claims/Year (New Position) -->
                ...
                <td class="p-2 ${item.commercial === 'Yes' ? 'text-green-700' : 'text-red-700'}">${item.commercial}</td> <!-- Commercial (New Position) -->
                <td class="p-2">${item.video_approval}</td> <!-- Video Approval (New Position) -->
